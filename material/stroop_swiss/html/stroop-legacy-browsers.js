...
function SETTINGRoutineBegin(snapshot) {
  return async function () {
    ...
    SETTINGComponents.forEach( function(thisComponent) {
...
function FullPracticeLoopLoopBegin(FullPracticeLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    FullPracticeLoop.forEach(function() {
...
function ControbilanciamewntoLoopLoopBegin(ControbilanciamewntoLoopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    ControbilanciamewntoLoop.forEach(function() {
...
function HUMANRoutineBegin(snapshot) {
  return async function () {
    ...
    HUMANComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function MATRIXRoutineBegin(snapshot) {
  return async function () {
    ...
    MATRIXComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ISTR_PRACTICERoutineBegin(snapshot) {
  return async function () {
    ...
    ISTR_PRACTICEComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ISTR_ESPERIMENTORoutineBegin(snapshot) {
  return async function () {
    ...
    ISTR_ESPERIMENTOComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TRIAL_ITARoutineBegin(snapshot) {
  return async function () {
    ...
    TRIAL_ITAComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TRIAL_ENGRoutineBegin(snapshot) {
  return async function () {
    ...
    TRIAL_ENGComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SWITCHRoutineBegin(snapshot) {
  return async function () {
    ...
    SWITCHComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function GRAZIERoutineBegin(snapshot) {
  return async function () {
    ...
    GRAZIEComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
