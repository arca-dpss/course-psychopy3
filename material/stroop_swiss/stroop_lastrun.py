...
textbox.reset()
# keep track of which components have finished
HUMANComponents = [human_txt, math_txt, textbox]
...
for thisComponent in HUMANComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('human_txt.started', human_txt.tStartRefresh)
thisExp.addData('human_txt.stopped', human_txt.tStopRefresh)
thisExp.addData('math_txt.started', math_txt.tStartRefresh)
thisExp.addData('math_txt.stopped', math_txt.tStopRefresh)
